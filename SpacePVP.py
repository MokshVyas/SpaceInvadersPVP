...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health,
    ...
    yellow_health_text = healthFont.render("Health: " + str(yellow_health), 1,
                                           white)
...
def main():
    red = pygame.Rect(1440, 540, spaceship_width, spaceship_height)
    yellow = pygame.Rect(480, 540, spaceship_width, spaceship_height)
    red_bullets = []
    yellow_bullets = []
    red_health = 10
    yellow_health = 10
